...
export const LogoIcon = ({ size = 32, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="8" y="22" width="6.5" height="11" rx="2.5" fill="url(#logoG)" />
    <rect x="16.5" y="15" width="6.5" height="18" rx="2.5" fill="url(#logoG)" />
    <rect x="25" y="8" width="6.5" height="25" rx="2.5" fill="url(#logoG)" />
    <circle cx="28.25" cy="5" r="2.5" fill="#38bdf8" />
  </svg>
);
...
export const IconTrendingDown = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
